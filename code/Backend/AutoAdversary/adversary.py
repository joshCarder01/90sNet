    ...
    event_checks[i] = {
        "ScoreRestartAction":{
            ...
            "actions": [
                {
                    "cmd": "cli",
                    "args": f"exec -t {i} truncate --size 0 /score.txt"
                }
            ]
        }
    }
